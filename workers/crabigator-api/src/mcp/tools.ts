...
export const toolDefs: ToolDef[] = [
    ...
    {
        name: 'send_keys',
        description: 'Send a named key (shift_tab, escape, tab, enter, up, down, option_up, ctrl_c) or a key-sequence of steps. option_up is the Codex pending-questions shortcut.',
        inputSchema: {
            type: 'object',
            required: ['session_id'],
            properties: {
                ...
                key: {
                    type: 'string',
                    description: 'Named key: shift_tab, escape, tab, enter, up, down, option_up, ctrl_c. option_up opens Codex pending questions.',
                },
                steps: {
                    type: 'array',
