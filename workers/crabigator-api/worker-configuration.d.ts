/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.example.jsonc` (hash: 92193c37738a640e5e1053e6f48a0aa8)
// Runtime types generated with workerd@1.20260820.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	TOKENS: KVNamespace;
	DB: D1Database;
	API_VERSION: "v1";
	APP_CONFIG: {"public_origin":"","features":{"transcription":true,"billing":false,"gifts":false,"outbound_email":false,"marketing_analytics":false,"traffic_alerts":false,"staff":false},"billing":{"visible_session_limit":3,"price_display":"$3","price_period":"per month","stripe_mode":"test","paypal_mode":"sandbox"},"email":{"mailgun_domain":"","from":"","traffic_alert_recipient":""},"marketing":{"meta_pixel_id":""},"operations":{"billing_cycle_day":1}};
	SESSION: DurableObjectNamespace<import("./src/index").SessionDO>;
	SESSION_LIST: DurableObjectNamespace<import("./src/index").SessionListDO>;
	USAGE: DurableObjectNamespace<import("./src/index").UsageDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SessionDO" | "SessionListDO" | "UsageDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_VERSION" | "APP_CONFIG">> {}
}
